...
void FUN_1004d404(unsigned short param_1)

{
  ...
  FUN_10001dd0(auStack_598,(unsigned long long)uRam10115f28 + 0x10,
...

{
  ...
  if ((int)lVar15 == 0) {
    ...
    FUN_10001dd0(uVar3,uVar7,lVar15);
  }
  ...
  FUN_10117884((int)piVar1 + (int)*(short *)(*piVar1 + 0x38),0,0);
  return;
}
